namespace LionTrust.Feature.Search.DataManagers.Interfaces
{
    ...
    public interface IFundSearchDataManager
    {
        ...
        ISearchResponse<IFundContentResult> GetFundListingResponse(string database, string fundTeams, string fundManagers, string fundRegions, string fundRanges, string searchTerm, string sortOrder, int page, string ids, bool hideFunds);
