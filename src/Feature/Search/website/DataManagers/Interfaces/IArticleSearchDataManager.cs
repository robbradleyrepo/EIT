namespace LionTrust.Feature.Search.DataManagers.Interfaces
{
    ...
    public interface IArticleSearchDataManager
    {
        ...
        ITaxonomySearchResponse GetArticleListingResponse(string funds, string fundCategories, string fundManagers, string fundTeams, int? month, int? year, string searchTerm, int page);
    }
}