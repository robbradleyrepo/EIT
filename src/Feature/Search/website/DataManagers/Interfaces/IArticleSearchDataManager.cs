namespace LionTrust.Feature.Search.DataManagers.Interfaces
{
    ...
    public interface IArticleSearchDataManager
    {
        ...
        ISearchResponse<ITaxonomyContentResult> GetArticleListingResponse(string database, string contentType, string funds, string categories, string fundManagers, string fundTeams, int? month, int? year, string searchTerm, string sortOrder, int page, int take = 21);
    }
}