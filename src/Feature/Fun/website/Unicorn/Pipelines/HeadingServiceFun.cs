...
namespace LionTrust.Feature.Fun.Unicorn.Pipelines
{
    /// <summary>
    ...
    public class HeadingServiceFun : HeadingService
    {
        ...
        {
            "LionTrust.Feature.Fun.Unicorn.Images.LionTrust.html",
            "LionTrust.Feature.Fun.Unicorn.Images.Unicorn.html",
            "LionTrust.Feature.Fun.Unicorn.Images.Unicorn.svg.html",
            "LionTrust.Feature.Fun.Unicorn.Images.Unicorn2.svg.html",
            "LionTrust.Feature.Fun.Unicorn.Images.Unicorn3.svg.html"
        };
