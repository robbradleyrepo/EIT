    ...
    var model = sitecore.Definitions.Models.ComponentModel.extend(
        {
            initialize: function() {
                ...
                this.set("usesPersonalisation", false);
                this.set("isServiceMessage", false);
                ...
                this.on("change:team", this.modified, this);
            ...
            getMessageFromServer: function() {
                ...
                var options = {
                    url: "/sitecore/api/ssc/LionTrust-Web-Controllers/LTMessage/1/Message",
                    data: data,
                    type: "POST",
            ...
            success: function(response) {
                ...
                this.set("team", response.message.team);
                this.set("teamPath", response.message.teamPath);
            ...
            getMessage: function() {
                ...
                for (var i = 0; i < variants.length; i++) {
                    ...
                    variants[i].plainText = encodeURIComponent(variants[i].plainText);
                ...
                var message = {
                    ...
                    usesPersonalisation: this.get("usesPersonalisation"),
                    isServiceMessage: this.get("isServiceMessage"),
                    usePreferredLanguage: this.get("usePreferredLanguage")
                };
