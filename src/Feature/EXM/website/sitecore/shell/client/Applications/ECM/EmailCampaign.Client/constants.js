define([], function () {
  return {
    ...
    ServerRequests: {
        ...
        LIST_MANAGEMENT_LIST: "ListManagement/LTList",
        ...
        SAVE_MESSAGE: "LionTrust-Web-Controllers/LTSaveMessage/1/SaveMessage",
    ...
    URLs: {
        ...
        CreateSegmentedList: '/sitecore/client/Applications/List Manager/Taskpages/Segmented list'
    }
  }
});