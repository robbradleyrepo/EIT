namespace LionTrust.Feature.Listings
{
    public static class Constants
    {
        ...
        public static class DocumentLister
        {
            ...
            public const string DateNewestText_FieldID = "{AAE23341-C861-4FBC-B0AB-16EA97A7FFC7}";
            public const string DateOldestText_FieldID = "{D3733E07-651D-4602-A5E6-9EA7953199BC}";
