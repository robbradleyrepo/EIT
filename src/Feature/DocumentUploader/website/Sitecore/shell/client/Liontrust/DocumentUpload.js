define(["sitecore"], function (Sitecore) {
    var model = Sitecore.Definitions.Models.ControlModel.extend({
        initialize: function (options) {
            ...
            $.ajax({
                url: "/sitecore/api/ssc/LionTrust-Web-Controllers/LTAdminDocumentUpload/1/LoadDocumentUploadPage",
                type: "POST",
            ...
            $(".btn-submit-documentUpload").click(function () {
                ...
                documentUploadEntity.SeletedDocumentType = selectedDocType;
                documentUploadEntity.UploadedFiles = uploadedFileList;

                $('.ltadmin-loader-gif').show();
                $.ajax({
                    url: "/sitecore/api/ssc/LionTrust-Web-Controllers/LTAdminDocumentUpload/1/UploadDocuments",
                    type: "POST",
