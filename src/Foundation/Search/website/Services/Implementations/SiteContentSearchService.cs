namespace LionTrust.Foundation.Search.Services.Implementations
{
    ...
    public class SiteContentSearchService : ISiteContentSearchService
    {
        private readonly IArticleContentSearchRepository _articleContentSearchRepository;

        public SiteContentSearchService(IArticleContentSearchRepository articleContentSearchRepository)
        {
