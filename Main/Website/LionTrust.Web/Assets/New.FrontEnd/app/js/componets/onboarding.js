...
export default () => {
    ...
    var countryName = '';
    var onBoardingBtn = $('.onboarding-overlay__set-step');
    ...
    onBoardingBtn.each(function() {
        var onBoardingNextStep = $(this).attr('data-set-step');
        $(this).find('.icon-arrow-right').attr('data-set-step', onBoardingNextStep);
        //console.log(onBoardingNextStep);
