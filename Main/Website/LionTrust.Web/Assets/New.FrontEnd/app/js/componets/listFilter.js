...
export default () => {
  ...
  const responce =  {
    "SearchResults": [
        {
            "Url": "://demo.liontrust/en/fund detail page",
            "CTAText": "test fund page text",
            "FundCardImageUrl": "fund card",
            "FundCardHeading": "asia fund card heading",
            "FundCardDescription": "asia fund card description ",
            "FundCategory": "The Sustainable Investment Team"
        },
        {
          "Url": "://demo.liontrust/en/fund detail page",
          "CTAText": "test fund page text",
